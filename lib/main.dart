...
import 'features/drawer_navigation/presentation/bloc/cubit/drawer_navigation_cubit.dart';
import 'features/home/presentation/bloc/cubit/working_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
            create: (context) => WorkingCubit(
                  workingDelivery: WorkingDeliveryImp(),
                )..getWorkingState()),
        BlocProvider(
          create: (context) =>
      ...
      child: BlocBuilder<LacalizationCubit, LacalizationState>(
        builder: (context, state) {
          return MaterialApp(
            title: 'Saudi Clean Services Delivery Side',
