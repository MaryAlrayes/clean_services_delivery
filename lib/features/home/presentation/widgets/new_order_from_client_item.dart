...
class NewOrderFromClientItem extends StatelessWidget {
  final NewOrder order;
  const NewOrderFromClientItem({
    Key? key,
    required this.order,
  }) : super(key: key);
      ...
      child: InkWell(
        onTap: () {
          Navigator.pushNamed(
            ...
            arguments: {'order': order, 'label':  AppLocalizations.of(context)!.order_bring_from_client},
          );
        },
        child: Padding(
