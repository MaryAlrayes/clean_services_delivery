...
class CurrentOrderBasicInfoCard extends StatelessWidget {
  final Order order;
  const CurrentOrderBasicInfoCard({
    Key? key,
    required this.order,
  }) : super(key: key);
  ...
  Widget _buildDate(BuildContext context) {
    return Text(AppLocalizations.of(context)!.custom_date_time(DateTime.now()),style: getRegularStyle(color: Colors.grey),);
  }
